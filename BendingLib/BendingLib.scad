module bend(Angle, remove_runover_part = true, _big_value = 1000) {
    angle = Angle % 360;
    _bendStart(angle, remove_runover_part, _big_value) children(0);
    _bentPart(angle, remove_runover_part, _big_value) children(0);
    _bendEnd(angle, remove_runover_part, _big_value) children(0);
}
