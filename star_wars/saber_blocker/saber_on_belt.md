...
Description of saber_on_belt sample openscad model inspired from the openscad logo.
...
```bash
npx openscad-generate@latest generate --mosaicFormat 2,2 --configFile saber_on_belt.yaml ./saber_on_belt.scad
```
