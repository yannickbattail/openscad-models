...
set_de_jeu sample openscad model inspired from the openscad logo.
...
```bash
npx openscad-generate generate --outFormats png,webp,3mf --mosaicFormat 2,2 --configFile set_de_jeu.config.json ./set_de_jeu.scad
```
